...
export class Crc32cHasher {
    __destroy_into_raw() {
        ...
        this.__wbg_ptr = 0;
        Crc32cHasherFinalization.unregister(this);
        return ptr;
    }
    free() {
        const ptr = this.__destroy_into_raw();
        wasm.__wbg_crc32chasher_free(ptr, 0);
    }
    /**
     ...
     */
    finalize() {
        const ret = wasm.crc32chasher_finalize(this.__wbg_ptr);
        return ret >>> 0;
    }
    constructor() {
        const ret = wasm.crc32chasher_new();
        this.__wbg_ptr = ret;
        Crc32cHasherFinalization.register(this, this.__wbg_ptr, this);
        return this;
    }
    /**
    ...
    update(data) {
        ...
        wasm.crc32chasher_update(this.__wbg_ptr, ptr0, len0);
    }
}
if (Symbol.dispose) Crc32cHasher.prototype[Symbol.dispose] = Crc32cHasher.prototype.free;
...
const Crc32cHasherFinalization = (typeof FinalizationRegistry === 'undefined')
    ? { register: () => {}, unregister: () => {} }
    : new FinalizationRegistry(ptr => wasm.__wbg_crc32chasher_free(ptr, 1));
